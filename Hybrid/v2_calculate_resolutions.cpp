// compile with
// g++ -o ../../build/v2_calculate_resolutions v2_calculate_resolutions.cpp `root-config --cflags --glibs` -Wl,--no-as-needed -lHist -lCore -lMathCore -lTree -lTreePlayer -lgsl -lgslcblas

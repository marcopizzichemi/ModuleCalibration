// compile with
// g++ -o ../../build/filterForDeepLearning_simulation filterForDeepLearning_simulation.cpp `root-config --cflags --glibs` -Wl,--no-as-needed -lHist -lCore -lMathCore -lTree -lTreePlayer -lgsl -lgslcblas
...
int main (int argc, char** argv)
{
  ...
  t1->Branch("RealX",&out_RealX,"RealX/F");
  t1->Branch("RealY",&out_RealY,"RealY/F");
  t1->Branch("RealZ",&out_RealZ,"RealZ/F");
